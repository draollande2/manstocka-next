...
-- Correction : la référence qualifiée public.product_stocks est invalide dans ON CONFLICT DO UPDATE
...
-- Validation d'inventaire : aligne le stock du point de vente sur la quantité comptée
...
-- Suppression d'un document avec réajustement automatique des stocks
